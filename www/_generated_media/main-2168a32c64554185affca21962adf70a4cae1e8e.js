...
$pyjs.loaded_modules['easy'] = function (__mod_name__) {
	...
	$m['ObjectRowWidget'] = (function(){
		...
		$method = $pyjs__bind_method2('__init__', function(as_json) {
			...
			var $iter2_array,$iter2_nextval,$iter1_nextval,$iter1_type,$iter2_iter,req,$iter1_iter,$iter2_idx,$assign1,$iter1_array,v,$iter2_type,data,k,$iter1_idx;
			...
			$iter2_iter = $p['list'](['edit_form_url', 'details_url']);
			$iter2_nextval=$p['__iter_prepare']($iter2_iter,false);
			while (typeof($p['__wrapped_next']($iter2_nextval).$nextval) != 'undefined') {
				req = $iter2_nextval.$nextval;
				if ($p['bool'](!$p['bool']($p['hasattr'](self, req)))) {
					$p['setattr'](self, req, '/not_implemented');
				}
			}
			self['redraw']();
			return null;
	...
	, 1, [null,null,['self'],['as_json']]);
		...
		$method = $pyjs__bind_method2('redraw', function() {
			...
			self['div']['append']((($attr1=($attr2=self)['bottom_panel']) == null || (($attr2.__is_instance__) && typeof $attr1 == 'function') || (typeof $attr1['__get__'] == 'function')?
						$p['getattr']($attr2, 'bottom_panel'):
						self['bottom_panel']));
			self['div']['tabs']();
			return null;
		}
	...
	, 1, [null,null,['self'],['html']]);
		...
		$method = $pyjs__bind_method2('control_links', function() {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
	...
	, 1, [null,null,['self']]);
		$cls_definition['control_links'] = $method;
		$method = $pyjs__bind_method2('addToList', function(target, show) {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if (typeof show == 'undefined') show=arguments.callee.__args__[4][1];
			var $attr3,$attr4;
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('parent', $m['j'](target)) : $p['setattr'](self, 'parent', $m['j'](target));
			if ($p['bool'](show)) {
				self['parent']['append']((($attr3=($attr4=self)['div']) == null || (($attr4.__is_instance__) && typeof $attr3 == 'function') || (typeof $attr3['__get__'] == 'function')?
							$p['getattr']($attr4, 'div'):
							self['div']));
			}
			return null;
		}
	, 1, [null,null,['self'],['target'],['show', true]]);
		$cls_definition['addToList'] = $method;
		$method = $pyjs__bind_method2('name_label', function() {
			...
			var $attr5,$attr6;
			return $m['j']('\x3Cspan\x3E')['addClass']('name')['html']((($attr5=($attr6=self)['nickname']) == null || (($attr6.__is_instance__) && typeof $attr5 == 'function') || (typeof $attr5['__get__'] == 'function')?
						$p['getattr']($attr6, 'nickname'):
						self['nickname']));
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('details_button', function() {
			...
			var $attr9,$attr8,$attr10,$attr7;
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('details_button_a', $m['j']('\x3Ca\x3E')['addClass']('details')) : $p['setattr'](self, 'details_button_a', $m['j']('\x3Ca\x3E')['addClass']('details'));
			self['details_button_a']['html']('Details')['attr']('href', self['details']());
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('details_button', self['control_link']((($attr7=($attr8=self)['details_button_a']) == null || (($attr8.__is_instance__) && typeof $attr7 == 'function') || (typeof $attr7['__get__'] == 'function')?
						$p['getattr']($attr8, 'details_button_a'):
						self['details_button_a']))) : $p['setattr'](self, 'details_button', self['control_link']((($attr7=($attr8=self)['details_button_a']) == null || (($attr8.__is_instance__) && typeof $attr7 == 'function') || (typeof $attr7['__get__'] == 'function')?
						$p['getattr']($attr8, 'details_button_a'):
						self['details_button_a'])));
			return (($attr9=($attr10=self)['details_button']) == null || (($attr10.__is_instance__) && typeof $attr9 == 'function') || (typeof $attr9['__get__'] == 'function')?
						$p['getattr']($attr10, 'details_button'):
						self['details_button']);
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('edit_button', function() {
			...
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('edit_button_a', $m['j']('\x3Ca\x3E')['addClass']('edit')) : $p['setattr'](self, 'edit_button_a', $m['j']('\x3Ca\x3E')['addClass']('edit'));
			self['edit_button_a']['html']('Edit')['attr']('href', self['edit_form']());
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('edit_button', self['control_link']((($attr11=($attr12=self)['edit_button_a']) == null || (($attr12.__is_instance__) && typeof $attr11 == 'function') || (typeof $attr11['__get__'] == 'function')?
						$p['getattr']($attr12, 'edit_button_a'):
						self['edit_button_a']))) : $p['setattr'](self, 'edit_button', self['control_link']((($attr11=($attr12=self)['edit_button_a']) == null || (($attr12.__is_instance__) && typeof $attr11 == 'function') || (typeof $attr11['__get__'] == 'function')?
						$p['getattr']($attr12, 'edit_button_a'):
						self['edit_button_a'])));
			return (($attr13=($attr14=self)['edit_button']) == null || (($attr14.__is_instance__) && typeof $attr13 == 'function') || (typeof $attr13['__get__'] == 'function')?
						$p['getattr']($attr14, 'edit_button'):
						self['edit_button']);
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('delete_button', function() {
			...
			var $attr20,$attr21,$attr22,$attr19,$attr18,$attr15,$attr17,$attr16;
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('delete_button_a', $m['j']('\x3Ca\x3E')['addClass']('delete')['html']('Delete')) : $p['setattr'](self, 'delete_button_a', $m['j']('\x3Ca\x3E')['addClass']('delete')['html']('Delete'));
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('delete_button', self['control_link']((($attr15=($attr16=self)['delete_button_a']) == null || (($attr16.__is_instance__) && typeof $attr15 == 'function') || (typeof $attr15['__get__'] == 'function')?
						$p['getattr']($attr16, 'delete_button_a'):
						self['delete_button_a']))) : $p['setattr'](self, 'delete_button', self['control_link']((($attr15=($attr16=self)['delete_button_a']) == null || (($attr16.__is_instance__) && typeof $attr15 == 'function') || (typeof $attr15['__get__'] == 'function')?
						$p['getattr']($attr16, 'delete_button_a'):
						self['delete_button_a'])));
			$m['j']((($attr17=($attr18=self)['delete_button']) == null || (($attr18.__is_instance__) && typeof $attr17 == 'function') || (typeof $attr17['__get__'] == 'function')?
						$p['getattr']($attr18, 'delete_button'):
						self['delete_button']))['bind']('click', (($attr19=($attr20=self)['confirm_delete']) == null || (($attr20.__is_instance__) && typeof $attr19 == 'function') || (typeof $attr19['__get__'] == 'function')?
						$p['getattr']($attr20, 'confirm_delete'):
						self['confirm_delete']));
			return (($attr21=($attr22=self)['delete_button']) == null || (($attr22.__is_instance__) && typeof $attr21 == 'function') || (typeof $attr21['__get__'] == 'function')?
						$p['getattr']($attr22, 'delete_button'):
						self['delete_button']);
		}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self'],['e']]);
		...
		$method = $pyjs__bind_method2('template', function(tgt) {
			...
			$iter3_iter = $p['list'](['id']);
			$iter3_nextval=$p['__iter_prepare']($iter3_iter,false);
			while (typeof($p['__wrapped_next']($iter3_nextval).$nextval) != 'undefined') {
				k = $iter3_nextval.$nextval;
				return tgt['$$replace']($p['sprintf']('{%s}', k), self['data']['get'](k, ''));
			}
			return null;
		}
	, 1, [null,null,['self'],['tgt']]);
		$cls_definition['template'] = $method;
		$method = $pyjs__bind_method2('details', function() {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $attr23,$attr24;
			return self['template']((($attr23=($attr24=self)['details_url']) == null || (($attr24.__is_instance__) && typeof $attr23 == 'function') || (typeof $attr23['__get__'] == 'function')?
						$p['getattr']($attr24, 'details_url'):
						self['details_url']));
		}
	, 1, [null,null,['self']]);
		$cls_definition['details'] = $method;
		$method = $pyjs__bind_method2('edit_form', function() {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			var $attr25,$attr26;
			return self['template']((($attr25=($attr26=self)['edit_form_url']) == null || (($attr26.__is_instance__) && typeof $attr25 == 'function') || (typeof $attr25['__get__'] == 'function')?
						$p['getattr']($attr26, 'edit_form_url'):
						self['edit_form_url']));
		}
	, 1, [null,null,['self']]);
		$cls_definition['edit_form'] = $method;
		var $bases = new Array($p['object']);
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data.__setitem__($item, $cls_definition[$item]); }
		return $p['_create_class']('ObjectRowWidget', $p['tuple']($bases), $data);
	})();
	$m['RouteRowWidget'] = (function(){
		var $cls_definition = new Object();
		var $method;
		$cls_definition.__module__ = 'easy';
		$method = $pyjs__bind_method2('__init__', function() {
			...
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('edit_form_url', '/route_form_partial/{id}') : $p['setattr'](self, 'edit_form_url', '/route_form_partial/{id}');
			...
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('details_url', '/route_details_partial/{id}') : $p['setattr'](self, 'details_url', '/route_details_partial/{id}');
			$pyjs_kwargs_call($p['$$super']($m['RouteRowWidget'], self), '__init__', args, kwargs, [{}]);
			return null;
		}
	, 1, ['args',['kwargs'],['self']]);
		$cls_definition['__init__'] = $method;
		$method = $pyjs__bind_method2('control_links', function() {
			...
			var $attr28,ul,$attr27,li;
			ul = $p['$$super']($m['RouteRowWidget'], self)['control_links']();
			li = self['graphs_button']();
			li['insertBefore']((($attr27=($attr28=self)['edit_button']) == null || (($attr28.__is_instance__) && typeof $attr27 == 'function') || (typeof $attr27['__get__'] == 'function')?
						$p['getattr']($attr28, 'edit_button'):
						self['edit_button']));
			return ul;
		}
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('graphs_button', function() {
			...
			var $attr33,$attr32,$attr31,$attr30,$attr34,$attr29;
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('graphs_button_a', $m['j']('\x3Ca\x3E')['addClass']('graphs')) : $p['setattr'](self, 'graphs_button_a', $m['j']('\x3Ca\x3E')['addClass']('graphs'));
			self['graphs_button_a']['html']('Graphs')['attr']('href', self['template']((($attr29=($attr30=self)['graphs_url']) == null || (($attr30.__is_instance__) && typeof $attr29 == 'function') || (typeof $attr29['__get__'] == 'function')?
						$p['getattr']($attr30, 'graphs_url'):
						self['graphs_url'])));
			self.__is_instance__ && typeof self.__setattr__ == 'function' ? self.__setattr__('graphs_button', self['control_link']((($attr31=($attr32=self)['graphs_button_a']) == null || (($attr32.__is_instance__) && typeof $attr31 == 'function') || (typeof $attr31['__get__'] == 'function')?
						$p['getattr']($attr32, 'graphs_button_a'):
						self['graphs_button_a']))) : $p['setattr'](self, 'graphs_button', self['control_link']((($attr31=($attr32=self)['graphs_button_a']) == null || (($attr32.__is_instance__) && typeof $attr31 == 'function') || (typeof $attr31['__get__'] == 'function')?
						$p['getattr']($attr32, 'graphs_button_a'):
						self['graphs_button_a'])));
			return (($attr33=($attr34=self)['graphs_button']) == null || (($attr34.__is_instance__) && typeof $attr33 == 'function') || (typeof $attr33['__get__'] == 'function')?
						$p['getattr']($attr34, 'graphs_button'):
						self['graphs_button']);
		}
	, 1, [null,null,['self']]);
		...
		var $data = $p['dict']();
		for (var $item in $cls_definition) { $data.__setitem__($item, $cls_definition[$item]); }
		return $p['_create_class']('RouteRowWidget', $p['tuple']($bases), $data);
	})();
	$m['loaded'] = function(event) {
		var obj,$iter4_nextval,$iter4_idx,$iter4_type,$iter4_array,$iter4_iter;
		$m['j']('.object_list')['html']('');
		$iter4_iter = $p['list'](object_list);
		$iter4_nextval=$p['__iter_prepare']($iter4_iter,false);
		while (typeof($p['__wrapped_next']($iter4_nextval).$nextval) != 'undefined') {
			obj = $iter4_nextval.$nextval;
			$m['RouteRowWidget'](obj)['addToList']('.object_list');
		}
		return null;
	};
