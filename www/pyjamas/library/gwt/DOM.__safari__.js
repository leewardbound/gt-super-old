...
$pyjs.loaded_modules['gwt.DOM'] = function (__mod_name__) {
	...
	$m['isOrHasChild'] = function(parent, child) {
		...
		while ($p['bool'](child)) {
			...
			if ($p['bool'](!$p['op_eq']((($attr73=($attr74=child)['nodeType']) == null || (($attr74.__is_instance__) && typeof $attr73 == 'function') || (typeof $attr73['__get__'] == 'function')?
    ...
    if (($m['sCaptureElem'] != null) 
            && $m['compare'](elem, $m['sCaptureElem']))
        $m['sCaptureElem'] = null;
...
element.innerHTML = html || "";
	...
	$m['sinkEvents'] = function(element, bits) {
		var dispEvnt,$iter3_type,$iter4_type,$iter4_iter,$attr82,$attr80,$iter3_idx,$iter2_iter,$iter3_nextval,$iter3_iter,$iter2_type,event_name,$iter2_idx,$attr81,$iter3_array,bit,$iter2_nextval,$attr79,$iter4_nextval,$iter4_idx,$iter4_array,$iter2_array;
element.__eventBits = bits;
		...
		while (typeof($p['__wrapped_next']($iter2_nextval).$nextval) != 'undefined') {
			...
			if ($p['bool']((bits)&(bit))) {
				$iter3_iter = (($attr79=($attr80=$m['Event'])['eventbits']) == null || (($attr80.__is_instance__) && typeof $attr79 == 'function') || (typeof $attr79['__get__'] == 'function')?
...
element['on'+event_name] = dispEvnt
				...
				$iter4_iter = (($attr81=($attr82=$m['Event'])['eventbits']) == null || (($attr82.__is_instance__) && typeof $attr81 == 'function') || (typeof $attr81['__get__'] == 'function')?
...
element['on'+event_name] = null
	...
	if ($p['bool'](!$p['bool']((($attr83=($attr84=$m['pyjd'])['is_desktop']) == null || (($attr84.__is_instance__) && typeof $attr83 == 'function') || (typeof $attr83['__get__'] == 'function')?
				$p['getattr']($attr84, 'is_desktop'):
				$m['pyjd']['is_desktop'])))) {
		$m['init']();
	}
	return this;
